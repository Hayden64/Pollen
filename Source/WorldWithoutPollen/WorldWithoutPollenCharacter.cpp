...
#include "WorldWithoutPollenProjectile.h"
...
void AWorldWithoutPollenCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{	
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent))
	{
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AWorldWithoutPollenCharacter::Move);
...
void AWorldWithoutPollenCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AWorldWithoutPollenCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
