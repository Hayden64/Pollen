...
#include "WorldWithoutPollen/TP_WeaponComponent.h"
...
WORLDWITHOUTPOLLEN_API UClass* Z_Construct_UClass_UTP_WeaponComponent();
WORLDWITHOUTPOLLEN_API UClass* Z_Construct_UClass_UTP_WeaponComponent_NoRegister();
...
struct Z_Construct_UFunction_UTP_WeaponComponent_AttachWeapon_Statics
{
	...
	{
		AWorldWithoutPollenCharacter* TargetCharacter;
		bool ReturnValue;
	};
#if WITH_METADATA
...
{
	P_GET_OBJECT(AWorldWithoutPollenCharacter,Z_Param_TargetCharacter);
	P_FINISH;
	P_NATIVE_BEGIN;
...
struct Z_Construct_UClass_UTP_WeaponComponent_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UTP_WeaponComponent_AttachWeapon, "AttachWeapon" }, // 1873855646
...
template<> WORLDWITHOUTPOLLEN_API UClass* StaticClass<UTP_WeaponComponent>()
{
	return UTP_WeaponComponent::StaticClass();
}
